...
- Added Mesh v2 quality settings for geometry quality, texture quality, and face count.
- Added GLB import support through the Unity glTFast package dependency.
- Fixed job polling for `InProgress` gateway status responses.
- Increased the prompt timeout range for longer-running generation jobs.
